<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Here you can edit the account details including name, email 
            country, City and phone number') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="nationality" type="text" class="mt-1 block w-full" wire:model.defer="state.nationality" required autocomplete="nationality" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="city" type="text" class="mt-1 block w-full" wire:model.defer="state.city" required autocomplete="city" />
